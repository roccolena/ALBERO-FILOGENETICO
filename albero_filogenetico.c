...
/*costruzione lista di adiacenza(inversa).inserisce ill'inizio della lista *primo un nuovo nodo con etichetta e
peso in ingresso e restituisce l'indirizzo del nuovo primo elemento della lista (usiamo una pila, LIFO)*/
...
/*costruzione dell'albero, salva in numero di nodi, alloca lo spazio per i puntatori alle liste di adiacenza, restituisce
l'albero*/
